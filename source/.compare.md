...
<!-- START_79d12cb0dfd9ed8ea51c6e7f3309d470 -->
## Add new asset
...
<!-- END_79d12cb0dfd9ed8ea51c6e7f3309d470 -->

<!-- START_86333a3f66eea21d090c62681b1c83ef -->
## Update asset
...
<!-- END_86333a3f66eea21d090c62681b1c83ef -->

<!-- START_9cf08ca8746aa9da25f21ba05e145e79 -->
## Get Asset Detail
...
Parameter | Type | Status | Description
--------- | ------- | ------- | ------- | -----------
    id | integer |  optional  | require The id of asset

<!-- END_9cf08ca8746aa9da25f21ba05e145e79 -->
...
<!-- START_7bb2cfab8cf5a5a0efdf4f5bd0d3d370 -->
## api/org/building
> Example request:

```bash
curl -X POST "/api/org/building" \
    -H "Authorization: Bearer {token}"
```

```javascript
const url = new URL("/api/org/building");
...
### HTTP Request
`POST api/org/building`


<!-- END_7bb2cfab8cf5a5a0efdf4f5bd0d3d370 -->

<!-- START_64a98d570319cc69a54c1ed6c2371f44 -->
## api/org/building
> Example request:

```bash
curl -X PUT "/api/org/building" \
    -H "Authorization: Bearer {token}"
```
...
### HTTP Request
`PUT api/org/building`


<!-- END_64a98d570319cc69a54c1ed6c2371f44 -->
...
<!-- START_2f7a18a0962b00de9679238437ce9192 -->
## api/org/business-unit
> Example request:

```bash
curl -X POST "/api/org/business-unit" \
    -H "Authorization: Bearer {token}"
```

```javascript
const url = new URL("/api/org/business-unit");
...
### HTTP Request
`POST api/org/business-unit`


<!-- END_2f7a18a0962b00de9679238437ce9192 -->

<!-- START_18a3bbf786a00040fc5dea0471659c21 -->
## api/org/business-unit
> Example request:

```bash
curl -X PUT "/api/org/business-unit" \
    -H "Authorization: Bearer {token}"
```
...
### HTTP Request
`PUT api/org/business-unit`


<!-- END_18a3bbf786a00040fc5dea0471659c21 -->

<!-- START_6db6fbeec696da569b5104e480bdf7bb -->
## api/org/business-unit/{bu}
> Example request:

```bash
curl -X GET -G "/api/org/business-unit/1" \
    -H "Authorization: Bearer {token}"
```

```javascript
const url = new URL("/api/org/business-unit/1");
...
### HTTP Request
`GET api/org/business-unit/{bu}`


<!-- END_6db6fbeec696da569b5104e480bdf7bb -->
...
curl -X POST "/api/org" \
    -H "Authorization: Bearer {token}" \
    -H "Content-Type: application/json" \
    -d '{"name":"The company A","location":"published","currency":"Vietnam","language":"USD","timezone":"voluptatum","logo":10}'
...
<!-- START_051fe0239f91b94f96e186b9987ce2c9 -->
...
<!-- END_051fe0239f91b94f96e186b9987ce2c9 -->

<!-- START_68edfd083b131e76e59159f5e964d756 -->
## Get Organization Detail
User get Organization detail
...
<!-- END_68edfd083b131e76e59159f5e964d756 -->
        ...
        "asset_types": [
            {
                ...
                "enabled": 1,
                "created_at": "2019-11-09 02:52:42",
                "updated_at": "2019-11-09 02:52:42"
            },
            {
                "id": 2,
                "name": "Atrium Space",
