...
<!-- START_6c89dd553e194b009eebb253c0f25490 -->
## Module information
...
```bash
curl -X GET -G "/api/asset/system-info" \
    -H "Authorization: Bearer {token}"
```

```javascript
const url = new URL("/api/asset/system-info");
...
### HTTP Request
`GET api/asset/system-info`


<!-- END_6c89dd553e194b009eebb253c0f25490 -->

<!-- START_1250ce55b1e74e60b5a5659c11950326 -->
## Add new asset
...
```bash
curl -X POST "/api/asset/add" \
    -H "Authorization: Bearer {token}" \
    -H "Content-Type: application/json" \
    -d '{"name":"The location A in floor 1","status":"published"}'

```

```javascript
const url = new URL("/api/asset/add");
...
let body = {
    "name": "The location A in floor 1",
    "status": "published"
}
...
--------- | ------- | ------- | ------- | -----------
    ...
    status | string |  optional  | option The status of asset, can be null or one of value default **draft** or **unpublished**, **published**  

<!-- END_1250ce55b1e74e60b5a5659c11950326 -->

<!-- START_2f626ce0568bd1a932753fa15ee5f43c -->
## api/asset/field/add
> Example request:

```bash
curl -X POST "/api/asset/field/add" \
    -H "Authorization: Bearer {token}"
```

```javascript
const url = new URL("/api/asset/field/add");
...
### HTTP Request
`POST api/asset/field/add`


<!-- END_2f626ce0568bd1a932753fa15ee5f43c -->

<!-- START_28502f6f049637e7d6edc9ebb1753c28 -->
## api/asset/update
> Example request:

```bash
curl -X POST "/api/asset/update" \
    -H "Authorization: Bearer {token}"
```

```javascript
const url = new URL("/api/asset/update");
...
<!-- END_28502f6f049637e7d6edc9ebb1753c28 -->

<!-- START_30373e81fe9417ba20c80e8df35f6bdb -->
## api/asset/info/{id}
> Example request:

```bash
curl -X GET -G "/api/asset/info/1" \
    -H "Authorization: Bearer {token}"
```

```javascript
const url = new URL("/api/asset/info/1");
...
<!-- END_30373e81fe9417ba20c80e8df35f6bdb -->

<!-- START_f4c4d1d9d87ecd83e32d05f404714d3e -->
## api/asset/search
> Example request:

```bash
curl -X GET -G "/api/asset/search" \
    -H "Authorization: Bearer {token}"
```

```javascript
const url = new URL("/api/asset/search");
...
<!-- END_f4c4d1d9d87ecd83e32d05f404714d3e -->

<!-- START_1ec9b8a82a9bb605271fc13e722c54f0 -->
## api/asset/public/search
> Example request:

```bash
curl -X GET -G "/api/asset/public/search" \
    -H "Authorization: Bearer {token}"
```

```javascript
const url = new URL("/api/asset/public/search");
...
```json
{
    ...
    "data": {
        "current_page": 1,
        "data": [],
        "first_page_url": "http:\/\/localhost\/api\/asset\/public\/search?page=1",
        "from": null,
        "last_page": 1,
        "last_page_url": "http:\/\/localhost\/api\/asset\/public\/search?page=1",
        "next_page_url": null,
        "path": "http:\/\/localhost\/api\/asset\/public\/search",
        "per_page": 15,
        "prev_page_url": null,
        "to": null,
        "total": 0
...
### HTTP Request
`GET api/asset/public/search`


<!-- END_1ec9b8a82a9bb605271fc13e722c54f0 -->

<!-- START_de5d6c03d8e52ad71ffec36b64a50005 -->
## api/asset/public/info/{id}
> Example request:

```bash
curl -X GET -G "/api/asset/public/info/1" \
    -H "Authorization: Bearer {token}"
```

```javascript
const url = new URL("/api/asset/public/info/1");
...
### HTTP Request
`GET api/asset/public/info/{id}`


<!-- END_de5d6c03d8e52ad71ffec36b64a50005 -->

#Booking


<!-- START_db157f41e9fec57c35ad047751c80432 -->
## api/asset/booking
> Example request:

```bash
curl -X POST "/api/asset/booking" \
    -H "Authorization: Bearer {token}"
```

```javascript
const url = new URL("/api/asset/booking");
...
### HTTP Request
`POST api/asset/booking`


<!-- END_db157f41e9fec57c35ad047751c80432 -->

<!-- START_1dd99c0f6929bacbaa1db4e44b4f9d59 -->
## api/asset/booking/{booking}
> Example request:

```bash
curl -X GET -G "/api/asset/booking/1" \
    -H "Authorization: Bearer {token}"
```

```javascript
const url = new URL("/api/asset/booking/1");
...
### HTTP Request
`GET api/asset/booking/{booking}`


<!-- END_1dd99c0f6929bacbaa1db4e44b4f9d59 -->

<!-- START_0c46fd82f087c590fd3afcf45f440342 -->
## api/asset/booking/approve/{booking}
> Example request:

```bash
curl -X POST "/api/asset/booking/approve/1" \
    -H "Authorization: Bearer {token}"
```

```javascript
const url = new URL("/api/asset/booking/approve/1");
...
### HTTP Request
`POST api/asset/booking/approve/{booking}`


<!-- END_0c46fd82f087c590fd3afcf45f440342 -->

<!-- START_07b62a0326a7f7bda1085e78e3b3851b -->
## api/asset/booking/reject/{booking}
> Example request:

```bash
curl -X POST "/api/asset/booking/reject/1" \
    -H "Authorization: Bearer {token}"
```

```javascript
const url = new URL("/api/asset/booking/reject/1");
...
### HTTP Request
`POST api/asset/booking/reject/{booking}`


<!-- END_07b62a0326a7f7bda1085e78e3b3851b -->

<!-- START_eb4bc24e60a953b5f29d33ab0a4ba774 -->
## api/asset/booking/search
> Example request:

```bash
curl -X GET -G "/api/asset/booking/search" \
    -H "Authorization: Bearer {token}"
```

```javascript
const url = new URL("/api/asset/booking/search");
...
### HTTP Request
`GET api/asset/booking/search`


<!-- END_eb4bc24e60a953b5f29d33ab0a4ba774 -->
...
<!-- START_b4a068ee13e80fa3f65c218736737be6 -->
## Create new category

<br><small style="padding: 1px 9px 2px;font-weight: bold;white-space: nowrap;color: #ffffff;-webkit-border-radius: 9px;-moz-border-radius: 9px;border-radius: 9px;background-color: #3a87ad;">Requires authentication</small>
This is API for create new category

> Example request:

```bash
curl -X POST "/api/category/create" \
    -H "Authorization: Bearer {token}" \
    -H "Content-Type: application/json" \
    -d '{"name":"Banana Origin","description":"This is banana , for imported banana","parent_id":2}'

```

```javascript
const url = new URL("/api/category/create");
...
let body = {
    "name": "Banana Origin",
    "description": "This is banana , for imported banana",
    "parent_id": 2
}
...
--------- | ------- | ------- | ------- | -----------
    ...
    description | string |  optional  | The description for category
    parent_id | integer |  optional  | The parent id of category for category

<!-- END_b4a068ee13e80fa3f65c218736737be6 -->

<!-- START_04ebd6ffed068cd64e5e1e66471c9cab -->
## Update A Category

> Example request:

```bash
curl -X POST "/api/category/update" \
    -H "Authorization: Bearer {token}"
```

```javascript
const url = new URL("/api/category/update");
...
<!-- END_04ebd6ffed068cd64e5e1e66471c9cab -->
...
```bash
curl -X POST "/api/category/delete/1" \
    -H "Authorization: Bearer {token}"
```

```javascript
const url = new URL("/api/category/delete/1");
...
<!-- START_8cd829f9ecae1af06aecb94f13233c37 -->
## api/asset/price/add
> Example request:

```bash
curl -X POST "/api/asset/price/add" \
    -H "Authorization: Bearer {token}"
```

```javascript
const url = new URL("/api/asset/price/add");
...
### HTTP Request
`POST api/asset/price/add`


<!-- END_8cd829f9ecae1af06aecb94f13233c37 -->

<!-- START_1da9288da6e1f01ea2692cda0877c105 -->
## api/asset/price/update
> Example request:

```bash
curl -X POST "/api/asset/price/update" \
    -H "Authorization: Bearer {token}"
```

```javascript
const url = new URL("/api/asset/price/update");
...
### HTTP Request
`POST api/asset/price/update`


<!-- END_1da9288da6e1f01ea2692cda0877c105 -->

<!-- START_c79727274c98d5b89412c00c50bd5c05 -->
## api/asset/price/calculate
> Example request:

```bash
curl -X POST "/api/asset/price/calculate" \
    -H "Authorization: Bearer {token}"
```

```javascript
const url = new URL("/api/asset/price/calculate");
...
### HTTP Request
`POST api/asset/price/calculate`


<!-- END_c79727274c98d5b89412c00c50bd5c05 -->

#Shura BackOffice


<!-- START_50d02acdce82bd32b7035039da77c9ff -->
## Get a list of navigation item for each authenticated user

> Example request:

```bash
curl -X GET -G "/api/backoffice/navigation" \
    -H "Authorization: Bearer {token}"
```

```javascript
const url = new URL("/api/backoffice/navigation");
...
### HTTP Request
`GET api/backoffice/navigation`


<!-- END_50d02acdce82bd32b7035039da77c9ff -->

#general


<!-- START_a75d0019df6bb9cea09b22cc3e66a509 -->
## api/upload/photo
> Example request:

```bash
curl -X POST "/api/upload/photo" \
    -H "Authorization: Bearer {token}"
```

```javascript
const url = new URL("/api/upload/photo");
...
<!-- END_a75d0019df6bb9cea09b22cc3e66a509 -->

<!-- START_7f0d5db48ac1eed21a5acb3c1291bfd5 -->
## api/media/list/{type}
> Example request:

```bash
curl -X POST "/api/media/list/1" \
    -H "Authorization: Bearer {token}"
```

```javascript
const url = new URL("/api/media/list/1");
    ...
    "data": {
        "asset_types": [
            {
                ...
                "enabled": 1,
                "created_at": "2019-10-17 08:23:46",
                "updated_at": "2019-10-17 08:23:46"
            },
            {
                "id": 2,
                "name": "Atrium Space",
        ...
        "events": {
            "Party": [
                ...
                },
                {
                    ...
                    "name": "After Prom",
                    "slug": "after-prom",
                    "system_id": "after-prom",
                    "group_id": 1,
                    "model": "event",
                    "group_name": "Party",
                    "description": "After Prom",
                    "is_published": 1,
                    "created_at": "2019-10-17 08:23:46",
                    "updated_at": "2019-10-17 08:23:46"
                },
            ...
            "Team Meeting": [
                {
                    ...
                    "is_published": 1,
                    "created_at": "2019-10-17 08:23:47",
                    "updated_at": "2019-10-17 08:23:47"
                },
                {
                    "id": 116,
                    "static_id": 70,
        ...
        "venue_types": [
            ...
            },
            {
                "id": 9,
                "static_id": 9,
                "name": "Kids & Recreational",
                "slug": "kids-recreational",
                "system_id": "kids-recreational",
                "group_id": 0,
                "model": "type",
                "group_name": "",
                "description": "Kids & Recreational",
                "is_published": 1,
                "created_at": "2019-10-17 08:23:46",
                "updated_at": "2019-10-17 08:23:46"
            },
            ...
            },
            {
                ...
                "name": "Halal Venue",
                "slug": "halal-venue",
                "system_id": "halal-venue",
                "group_id": 0,
                "model": "type",
                "group_name": "",
                "description": "Halal Venue",
                "is_published": 1,
                "created_at": "2019-10-17 08:23:46",
                "updated_at": "2019-10-17 08:23:46"
            },
            ...
            },
            {
                "id": 14,
                "static_id": 14,
                "name": "Meeting Room\/Space",
                "slug": "meeting-room-space",
                "system_id": "meeting-room-space",
                "group_id": 0,
                "model": "type",
                "group_name": "",
            ...
            },
            {
                ...
                "name": "Unique venue",
                "slug": "unique-venue",
                "system_id": "unique-venue",
                "group_id": 0,
                "model": "type",
                "group_name": "",
                "description": "Unique venue",
                "is_published": 1,
                "created_at": "2019-10-17 08:23:46",
                "updated_at": "2019-10-17 08:23:46"
            },
        ...
        "amenities": [
            ...
            },
            {
                "id": 38,
                "static_id": 3,
                "name": "Bring your own stuff",
                "slug": "bring-your-own-stuff",
                "system_id": "bring-your-own-stuff",
                "group_id": 0,
                "model": "amenities",
                "group_name": "",
                "description": "Bring your own stuff",
                "is_published": 1,
                "created_at": "2019-10-17 08:23:46",
                "updated_at": "2019-10-17 08:23:46"
            },
            ...
            },
            {
                ...
                "name": "Projector\/TV",
                "slug": "projector-tv",
                "system_id": "projector-tv",
                "group_id": 0,
                "model": "amenities",
                "group_name": "",
                "description": "Projector\/TV",
                "is_published": 1,
                "created_at": "2019-10-17 08:23:46",
                "updated_at": "2019-10-17 08:23:46"
            },
        ...
        "timezone": [
            {
                "id": "Asia\/Singapore",
                "value": "GMT+8 Asia\/Singapore"
            },
            {
                "id": "Asia\/Ho_Chi_Minh",
                "value": "GMT+7 Asia\/Ho_Chi_Minh"
            }
        ],
        "price_options": {
            "type": [
...
<!-- END_4b9cbc8a5180be935252eedd023fb313 -->
